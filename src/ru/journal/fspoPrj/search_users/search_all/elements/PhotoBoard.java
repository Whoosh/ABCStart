...
public class PhotoBoard extends View {
    ...
    private class Board extends Drawable {
        ...
        public Board() {
           ...
           // board = Bitmap.createBitmap(Config.imgLayWidth, Config.imgLayHeight, Bitmap.Config.ARGB_8888);
            Canvas canvas = new Canvas(board);
          //  canvas.drawCircle(Config.imgLayWidth / 2,Config.imgLayHeight / 2,Config.imgLayHeight / 2, paint);
